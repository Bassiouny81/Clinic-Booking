...
import { patientsTable, appointmentsTable, notificationsTable, } from "@workspace/db/schema";
import { eq } from "drizzle-orm";
import { sendWhatsAppNotification } from "../lib/whatsapp";
const router = Router();
router.post("/booking", async (req, res) => {
    try {
        const { patientName, patientPhone, patientEmail, doctorId, serviceId, appointmentTypeId, scheduledAt, mode, notes, } = req.body;
